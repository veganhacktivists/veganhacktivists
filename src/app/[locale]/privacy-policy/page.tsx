...
const PrivacyPolicy = () => {
  return (
    <div className='m-auto px-2 py-16 w-full md:w-[760px] text-left'>
      ...
      <ul className='py-4 pl-8'>
        <li className='list-disc'>
          <span className='font-bold'>By Law or to Protect Rights:</span>
          <span>
      ...
      <ul className='py-4 pl-8'>
        <li className='list-disc'>
          ...
          <span>
            &nbsp;You can request information about the categories and specific
            pieces of personal data we have collected about you.
          </span>
        </li>
        <li className='list-disc'>
          <span className='font-bold'>Right to Delete:</span>
          <span>
            &nbsp;You can request the deletion of your personal data that we
            have collected.
          </span>
        </li>
        <li className='list-disc'>
          <span className='font-bold'>Right to Opt-Out:</span>
          <span>
            &nbsp;You can request that we do not sell your personal data to
            third parties.
          </span>
        </li>
        <li className='list-disc'>
          <span className='font-bold'>Right to Non-Discrimination:</span>
          <span>
      ...
      <ul className='py-4 pl-8'>
        <li className='list-disc'>
          <span className='font-bold'>Right to Access:</span>
          <span>
      ...
      <ul className='py-4 pl-8'>
        <li className='list-disc'>
          ...
          <span>
            ...
            about you and to know how it has been used and to whom it has been
            disclosed.
          </span>
        </li>
        <li className='list-disc'>
          <span className='font-bold'>Right to Correction:</span>
          <span>
        ...
        <li className='list-disc'>
          ...
          <span>
            &nbsp;You can withdraw your consent to the collection, use, and
            disclosure of your personal information at any time, subject to
            legal or contractual restrictions and reasonable notice.
          </span>
        </li>
        <li className='list-disc'>
          <span className='font-bold'>Right to Complain:</span>
          <span>
            &nbsp;You have the right to complain to the Privacy Commissioner of
            Canada about our handling of your personal information.
          </span>
        </li>
      </ul>
      <p>
