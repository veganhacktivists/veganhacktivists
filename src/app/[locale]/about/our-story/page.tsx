...
const OurStory: React.FC<Props> = ({ params: { locale } }) => {
  const intl = getServerIntl(locale);
          ...
          {intl.formatMessage(
            {
              ...
              defaultMessage:
                'Through it all, our North Star remains the same: <no-localization>{break}</no-localization> we do it for the animals.',
            },
            {
              break: <br />,
            },
