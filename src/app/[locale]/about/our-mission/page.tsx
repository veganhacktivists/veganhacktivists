...
import PixelCow from '~images/VH_PixelCow.png';
...
const OurMission: React.FC<Props> = ({ params: { locale } }) => {
  const intl = getServerIntl(locale);
    ...
    <>
      ...
      >
        {intl.formatMessage({
          ...
          defaultMessage:
            'Our mission is to build data-driven, disruptive, and innovative projects to help see an end to animal exploitation. We believe the animal protection movement has five fundamental areas for improvement, which we aim to solve through our work.',
        })}
      </FirstSubSection>
        ...
        <div>
          ...
          >
            {intl.formatMessage({
              ...
              defaultMessage:
                "We strongly believe competition is not only healthy but vital in improving our movement's effectiveness. Competition applies healthy pressure on organizations and projects to keep improving and iterating - and this gives us more information on what works.",
            })}
          </SubSection>
          <SubSection
            header={intl.formatMessage({
          ...
          >
            {intl.formatMessage({
              ...
              defaultMessage:
                'We believe the movement has the potential to be more innovative in its approaches. We promote outside-the-box thinking and make innovation a core consideration of every part of our work and our processes.',
            })}
          </SubSection>
          <SubSection
            header={intl.formatMessage({
