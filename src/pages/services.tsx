  ...
  <>
    ...
    <div>
      ...
      <div className="text-grey content-center mx-auto my-20 md:w-1/2 drop-shadow-2xl text-2xl">
          ...
          <p>
            Aside from building our own projects, we also serve the greater community! 
			If you’re an animal rights activist, organization, or just a vegan who needs help 
			- let us know! Please keep in mind that while all of our services are free this 
			unfortunately means we have to be selective with who we can help with our 
			limited resources. Ask us either way!
          </p>
        </div>
