...
const Requestors: NextPage = () => {
  ...
  return (
    <>
    <SubMenu title="Requestors" entries={[{ title: 'Requests', link: '/playground/admin' }, { title: 'Applications', link: '/playground/admin/applications' }, { title: 'Requestors', link: '', active: true }]}/>
