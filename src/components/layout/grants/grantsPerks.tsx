...
const GrantsPerks: React.FC = () => {
  return (
    <div className="p-0 md:p-12 lg:p-0 pt-12 max-w-screen-lg mx-auto">
      <Image
        src={PixelHeart.src}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 py-10">
        <div className="flex items-center">
          <Image src={squarespaceImage} alt="squarespace" />
        </div>
        <div className="ml-0 md:ml-8 flex flex-col justify-center mt-6 md:mt-0 px-4 md:px-0">
          <h4 className="text-3xl font-semibold">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 py-10">
        ...
        <div className="ml-0 md:ml-8 flex flex-col justify-center mt-6 md:mt-0 px-4 md:px-0">
          ...
          <p className="text-xl mt-6 leading-loose">
            <div>
              We can help with any written content creation, including checking
              your existing content, grammar, spelling, and the creation of
              content that helps with promoting your work.
            </div>
          </p>
        </div>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 py-10">
        <div className="flex items-center">
          <Image src={designerImage} alt="designer" />
        </div>
        <div className="ml-0 md:ml-8 flex flex-col justify-center mt-6 md:mt-0 px-4 md:px-0">
