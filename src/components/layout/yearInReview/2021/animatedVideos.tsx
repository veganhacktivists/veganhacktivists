...
const AnimatedVideos: React.FC = () => {
  return (
    <div className="bg-grey-background pb-40">
      <SectionHeader
        className="text-grey"
      ...
      >
        ...
        (formerly known as Better Eating International) in order to produce two
        animated introductory videos for Activist Hub and Vegan Bootcamp! These
        videos are fantastic resources for viewers to quickly get familiar with
        our work when on our landing page. We had a great time working with the
        Expanded Circle team and we&apos;ll be producing more with them for
        2022.
      </SectionHeader>
