      ...
      <SectionContainer color="grey-darker" className="text-white">
        <div className="text-center md:w-1/2 mx-auto space-y-5">
          ...
          <FormattedMessage
            ...
            <p>This year, we have also prioritized organizing and optimizing internal processes. This was crucial for us since a core focus of 2022 is to expand our volunteer network to meet the demand of our services. We want to continue being able to serve the multifaceted needs of the vegan movement and empower people to become activists.</p>
            <p>We're really excited to hear your thoughts in our 2021 year in review, and if you like what we do, please consider supporting us by clicking the button below. Your donation ensures that all of our work and projects remain free and accessible to everyone, and we can't begin to thank you enough for the support!</p>"
            values={{
              p: (chunks) => <p>{chunks}</p>,
            }}
          />
