      ...
      <SectionContainer color="grey-dark" className="text-white">
        <div className="flex flex-col-reverse md:flex-row gap-x-24 md:w-2/3 justify-center mx-auto">
          ...
          <div className="text-2xl md:text-left mx-auto md:w-2/3 space-y-5">
            ...
            <p>
            This year, we decided to professionally rebrand both the organization 
            and our website from the ground up. We wanted our branding to still 
            deeply represent our tech background, but also be far more inviting 
            and fun to better represent our work and our community.
            </p>
            <p>
            We saw an immediate increase in applications on both our website and 
            social platforms from interested volunteers for those who found us 
            on either platform.
            </p>
            <p>
