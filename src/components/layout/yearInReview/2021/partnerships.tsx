...
import otherPartner from '~images/yearInReview/2021/partner_other.png';
import pollinationPartner from '~images/yearInReview/2021/partner_pollinationproject.png';
import avPartner from '~images/yearInReview/2021/partner_av.png';
              ...
              {intl.formatMessage(
                {
                  ...
                  defaultMessage:
                    "We were very happy to <link>announce a partnership</link> in where we're able to offer up to $1000 USD in seed funding grants for outstanding, and effective, animal rights activism! Specifically we're looking for individual or grassroots groups whose primary purpose is to help reduce suffering for non-human farmed animals.",
                },
                {
                  link: (chunks) => (
              ...
              {intl.formatMessage(
                {
                  ...
                  defaultMessage:
                    "We're excited to see where this partnership leads us in the future as we work together with <link>The Pollination Project</link> to get these activists funded as much as possible.",
                },
                {
                  link: (chunks) => (
              ...
              {intl.formatMessage(
                {
                  ...
                  defaultMessage:
                    "Traditionally, it's been very hard to track the effectiveness of street outreach. We're excited to have partnered up with <no-localization>AV</no-localization> in order to be able to provide them the tools they need to monitor and track the effectiveness of each group with <link>Activist Hub</link>.",
                },
                {
                  link: (chunks) => (
          ...
          >
            <p>
                ...
                <span className='block md:inline'>
                  <b>
                    {intl.formatMessage({
                      ...
                      defaultMessage:
                        '<no-localization>Vegan Outreach</no-localization>',
                    })}
                  </b>
                </span>
              </CustomLink>
              ...
              {intl.formatMessage({
                ...
                defaultMessage:
                  "We partnered with <no-localization>Vegan Outreach's</no-localization> Vegan Mentorship Program in order to provide completely free mentorship access to all <no-localization>Vegan Bootcamp</no-localization> and <no-localization>3Movies.org</no-localization> participants.",
              })}
            </p>
            <p className='pb-20'>
                ...
                <span className='block md:inline'>
                  <b>
                    {intl.formatMessage({
                      ...
                      defaultMessage:
                        '<no-localization>Legal Impact for Chickens</no-localization>',
                    })}
                  </b>
                </span>
              </CustomLink>
              ...
              {intl.formatMessage({
                ...
                defaultMessage:
                  "We partnered with <no-localization>Legal Impact for Chickens</no-localization> for our upcoming project, <no-localization>Start Pressuring!</no-localization> We'll be able to provide successful pressure campaigns launched on our platform with free legal support!",
              })}
            </p>
          </Partnership>
        </div>
