...
import PlaygroundImage from '~images/yearInReview/2022/playground.png';
              ...
              <div className='text-white text-left'>
                ...
                <span className='text-xl'>
                  ...
                  {intl.formatMessage({
                    ...
                    defaultMessage:
                      "Over 45 requests from organizations have been supported since our launch. Over 1500 volunteers have joined the <no-localization>Playground</no-localization> community, and it's growing every day!",
                  })}
                  <br />
                  <br />
                  {intl.formatMessage({
