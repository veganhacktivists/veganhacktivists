...
const Partnerships: React.FC = () => (
  <>
    ...
    <div className='bg-magenta flex flex-col lg:flex-row justify-center md:first-letter:flex-wrap p-16 px-2'>
      <div className='items-center flex-wrap text-white text-3xl sm:text-6xl font-mono px-2 justify-center font-light uppercase'>
        <FormattedMessage
