...
import TechAndDataImg from '../../../../../public/images/yearInReview/2023/tech--and-data-in-the-movement.jpg';
            ...
            <div>
              ...
              <div className='text-lg pt-8 pb-4'>
                <FormattedMessage
                  ...
                  defaultMessage='In August 2023, we took a significant step forward by releasing a comprehensive report on the integration of technology and data within the animal advocacy movement. Our 50-page study revealed critical insights into how technology is currently utilized and the potential it holds to further our cause. We delved into various aspects including workforce tech skills, the use of websites and applications, social media strategies, data collection practices, and security measures.{break}{break}Our findings underscore the necessity for a more tech-savvy approach in our activities and advocacy. To aid in this transition, we have formulated several recommendations aimed at leaders, activists, and funders. These guidelines are designed to foster a more technology-forward and data-driven approach, enhancing our effectiveness in animal protection.{break}{break}By sharing these insights and recommendations, we aim to catalyze a shift towards better utilization of technology across the movement. This report is not just a reflection of where we stand, but a roadmap for where we need to go, ensuring we leverage every tool available to advocate for animal welfare more efficiently.{break}{break}<b>Haven’t read the study yet?</b>'
                  values={{
                    b: (chunks) => <b>{chunks}</b>,
                    break: <br />,
                  }}
