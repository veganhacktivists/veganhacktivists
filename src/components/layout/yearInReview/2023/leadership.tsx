...
import LeadershipPigs from '../../../../../public/images/yearInReview/2023/leadership-pigs.jpg';
  ...
  return (
    <>
      <div className='flex flex-col md:flex-row text-left bg-white'>
            ...
            <div className='md:py-16'>
              ...
              <div className='flex flex-row justify-between mt-4'>
                <DarkButton
                  ...
                  href='https://veganhacktivists.org/blog/new-horizons-for-vh-leadership'
                  newTab
                >
                  {buttonLabel}
                </DarkButton>
        ...
        <div className='basis-full md:basis-1/2 flex justify-center md:justify-start items-center p-10'>
