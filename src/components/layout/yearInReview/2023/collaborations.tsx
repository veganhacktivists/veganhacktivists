...
const Collaborations: React.FC = () => {
  ...
  return (
    <>
      ...
      />
      <div className='max-w-6xl mx-auto text-2xl sm:text-4xl p-10 sm:p-16'>
        <FormattedMessage
      ...
      <div className='max-w-screen-2xl p-10 mx-auto flex flex-col gap-10'>
        <div className='flex flex-col lg:grid lg:grid-cols-3 gap-10'>
          <div className='text-lg text-left lg:col-span-2'>
            <div className='flex items-center mb-5'>
              <div className='bg-green flex items-center justify-center text-7xl text-white font-bold font-mono w-20 h-20 p-3 mr-10'>
                1
              </div>
              <SectionHeader
        ...
        <div className='flex flex-col lg:grid lg:grid-cols-3 gap-10'>
          <div className='text-lg text-left lg:col-span-2'>
            <div className='flex items-center mb-5'>
              <div className='bg-yellow-orange flex items-center justify-center text-7xl text-white font-bold font-mono w-20 h-20 p-3 mr-10'>
                2
              </div>
              <SectionHeader
                header={intl.formatMessage({
        ...
        <div className='flex flex-col lg:grid lg:grid-cols-3 gap-10'>
          <div className='text-lg text-left lg:col-span-2'>
            <div className='flex items-center mb-5'>
              <div className='bg-orange flex items-center justify-center text-7xl text-white font-bold font-mono w-20 h-20 p-3 mr-10'>
                3
              </div>
              <SectionHeader
                header={intl.formatMessage({
