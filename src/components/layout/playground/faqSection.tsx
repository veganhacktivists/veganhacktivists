...
const faqSection: React.FC<FaqSection> = ({ design }) => {
  const faqEntries = [
    ...
    { 
      ...
      content: 'If you&apos;re an organization or animal advocate seeking support for your project, just click on “Submit a request” and let our community know exactly what you need help with. Once you submit your request, we&apos;ll review it to make sure it fits our community standards, and then either approve or decline the request. You&apos;ll get an email letting you know when your request is live and public, and then all you have to do is wait for our community of volunteers to apply to help! We&apos;ll review all applications that have applied to help you, vet them the best that we can, and then approve the best one. You&apos;ll automatically be connected with the volunteer over email with a Calendy link!' 
    },
    {
      headline: 'How does it work if I want to volunteer my time here?',
      content: 'All vegans that can code, design, or have another valuable skill to contribute, are welcome here! Simply browse the list of requests here on Playground and choose and apply to the one that is most relevant to your skill-set. Make sure you&apos;re able to commit a reasonable amount of time to help with the request, and make sure that you have the skills to do it properly. Below the request you&apos;ll be able to fill out information we&apos;ll need from you, and once submitted, we&apos;ll review your application and make a decision. You&apos;ll get an email whether you&apos;ve been approved or declined to help, if approved, we&apos;ll automatically connect you to the requestor with a Calends link so that you can get started!',
    },
    {
      headline: 'Are people applying to my request qualified?',
      content: 'Anyone can join this community and apply to help you with your request, however, Vegan Hacktivists does the work in reviewing those applications for you. While we can&apos;t guarantee the quality of work, we&apos;ll do our best to make sure that the applicant has the skills and time available to help you. Our review process includes reviewing their LinkedIn, Portfolio, Resume, past work, and social media profiles. Depending on the request, we may also personally interview the applicant over the phone or via email before accepting their application to help with your request.',
    },
    {
      headline: 'I&apos;d rather get support from the core VH team, is that possible?',
      content: 'Unfortunately, our core team of developers, designers and specialists are almost always over capacity in the work that we do on personal projects and for other advocates and organizations. Playground was designed with the aim to increase the capacity in which we can help you and others by leveraging our massive network of vegan communities to find volunteers for you. Playground will almost always be able to meet your needs as much as the core VH team could, so give it a try!',
    },
    {
      headline: 'How long does it take for my request/application to get accepted?',
      content: 'If you&apos;re submitting a request for support, we usually are able to review and get it live within 24 hours. If you&apos;re submitting to help someone with a request, it takes about 24 to 48 hours for us to review your application before we accept or decline your request. It can take anywhere from 1 to 7 days for us to find a suitable person to help you with your request, please be patient as we&apos;re new and still growing!',
    },
    {
      headline: 'As a volunteer, can I stay updated on new requests that come in?',
      content: 'Absolutely! Join our Playground Discord server, all new requests get posted automatically there. You&apos;ll get notifications and you&apos;ll also be able to chat and discuss your volunteer work and experiences, as-well as get support with the Playground community there. We&apos;re looking forward to seeing you soon!',
    },
  ];
  return (
    <div>
